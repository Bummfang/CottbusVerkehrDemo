    ...
    return (
        <div className="w-full flex  bg-[#c22727] animate-fadeInAnimation">
            <div className="w-[10rem] h-[60%] min-h-[45rem] ml-16 mt-14 shadow-2xl border bg-slate-100 rounded-3xl grid grid-col-1 grid-row-4 place-items-center">
                ...
                <div onClick={props.toContentManagement} className="hover:shadow-xl hover:scale-[110%] group hover:cursor-pointer duration-500 hover:bg-[#c22727] w-[80%] h-[7rem] rounded-2xl flex flex-col justify-center items-center">
                ...
                <div onClick={props.toDatabaseAccess} className="hover:shadow-xl hover:scale-[110%] group hover:cursor-pointer duration-500 hover:bg-[#c22727] w-[80%] h-[7rem] rounded-2xl flex flex-col justify-center items-center">
                ...
                <div onClick={props.toOptions} className="hover:shadow-xl hover:scale-[110%] group hover:cursor-pointer duration-500 hover:bg-[#c22727] w-[80%] h-[7rem] rounded-2xl flex flex-col justify-center items-center">
                ...
                <div onClick={props.toLogin} className="hover:shadow-xl hover:scale-[110%] group hover:cursor-pointer duration-500 hover:bg-[#c22727] w-[80%] h-[7rem] rounded-2xl flex flex-col justify-center items-center">
